...
def buscar_spots_aida_1():
    return [
        ...
        [
            [['SM', 'MG'], [(176, 16)], (398, 240)],  # 3
            [['DL'], [(188, 18)], (561, 370)],
            [['EF'], [(198, 17)], (356, 233)]  # ok
        ],
        [
            [['SM', 'MG'], [(225, 12)], (398, 240)],  # 4
            [['DL'], [(228, 12)], (218, 184)],
            [['EF'], [(231, 13)], (263, 210)]
        ],
        [
            [['SM', 'MG'], [(213, 33)], (398, 240)],  # 5
            [['DL'], [(215, 32)], (238, 161)],
            [['EF'], [(219, 34)], (236, 219)]
        ],
        [
            [['SM', 'MG'], [(210, 77)], (398, 240)],  # 6
            [['DL'], [(209, 73)], (618, 154)],
            [['EF'], [(207, 67)], (545, 234)]
        ],
        [
            [['SM', 'MG', 'BK'], [(185, 96)], (398, 240)],  # 7
            [['DL'], [(189, 96)], (223, 146)],
            [['EF'], [(194, 94)], (281, 166)]
        ],
        [
            [['SM', 'MG', 'BK'], [(229, 133)], (398, 240)],  # 8
            [['DL'], [(233, 128)], (373, 120)],
            [['EF'], [(235, 124)], (405, 162)]
        ]
    ]
