...
def buscar_spots_tk1():
    coordenadas = []
    coordenadas.extend([
        [
            [['SM', 'MG', 'BK'], [(201, 107)], (398, 240)],  # 0
            [['DL'], [(204, 104)], (395, 128)]
        ],
        [
            [['SM', 'MG', 'BK'], [(172, 124)], (398, 240)],  # 1
            [['DL'], [(176, 126)], (285, 246)]
        ],
        [
            [['SM', 'MG', 'BK'], [(156, 149)], (398, 240)],  # 2
            [['DL'], [(158, 147)], (375, 142)]
        ],
        [
            [['SM', 'MG', 'BK'], [(96, 36)], (398, 240)],  # 3
            [['DL'], [(98, 34)], (402, 170)]
        ],
        [
            [['SM', 'MG', 'BK'], [(38, 62)], (398, 240)],  # 4
            [['DL'], [(42, 62)], (326, 196)]
        ],
        [
            [['SM', 'MG', 'BK'], [(20, 91)], (398, 240)],  # 5
            [['DL'], [(23, 88)], (487, 171)]
        ]
    ])
    return coordenadas
...
def buscar_spots_tk2(nao_ignorar_spot_pk=False):
    coordenadas = []

    if nao_ignorar_spot_pk:
        coordenadas.extend([
            [
                [['SM', 'MG', 'BK'], [(39, 171)], (398, 240)],  # 0
                [['DL'], [(37, 167)], (561, 185)]
            ],
            [
                [['SM', 'MG', 'BK'], [(61, 122)], (398, 240)],  # 1
                [['DL'], [(62, 120)], (459, 161)]
            ],
            [
                [['SM', 'MG', 'BK'], [(161, 191)], (398, 240)],  # 2
                [['DL'], [(162, 187)], (490, 184)]
            ],
            [
                [['SM', 'MG', 'BK'], [(177, 209)], (398, 240)],  # 3
                [['DL'], [(177, 204)], (521, 217)]
            ],
            [
                [['SM', 'MG', 'BK'], [(161, 225)], (398, 240)],  # 4
                [['DL'], [(163, 224)], (349, 177)]
            ],
            [
                [['SM', 'MG', 'BK'], [(155, 222)], (398, 240)]  # 5
            ],
            [
                [['SM', 'MG', 'BK'], [(111, 213)], (398, 240)],  # 6
                [['DL'], [(114, 210)], (382, 175)]
            ],
            [
                [['SM', 'MG', 'BK'], [(84, 202)], (398, 240)],  # 7
                [['DL'], [(88, 201)], (307, 242)]
            ]
        ])
...
def buscar_spots_aida_1(ignorar_spot_pk=False):
    ...
    coordenadas.extend([
        ...
        [
            ...
            [['DL'], [(169, 58)], (238, 161)]  # FALTA CORRIGIR COORDENADA MOUSE
        ],

        [
            [['SM', 'MG'], [(167, 45)], (398, 240)],  # 6
            [['DL'], [(173, 46)], (238, 161)]  # FALTA CORRIGIR COORDENADA MOUSE
        ],
